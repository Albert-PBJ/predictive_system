...
class Command(BaseCommand):
    help = "Scrape competitor websites via Apify AI web scraper and store results in CompetitorMarketData"
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            nargs="+",
            type=str,
            help="Website URL(s) to scrape, e.g. https://competidor.com/productos/",
        )
        parser.add_argument(
            "--limit",
            type=int,
        ...
        parser.add_argument(
            ...
            default=None,
            metavar="NAME",
            help="Nombre del competidor (si se omite, se deriva del dominio de la URL)",
        )
